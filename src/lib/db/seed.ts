...
async function seedImage(index: number, title: string) {
  ...
  const preview = await sharp(data)
    .resize({ width: 520, height: 346 })
    .webp({ quality: 72 })
    .toBuffer();
  return {
    data: new Uint8Array(data),
    previewData: new Uint8Array(preview),
    mimeType: "image/webp",
    size: data.length,
    width: 960,
    height: 640,
...
const userId = (index: number) =>
  `user:staff-${((index - 1) % staff.length) + 1}`;
const roomId = (index: number) =>
  `room:${rooms[(index - 1) % rooms.length].id}`;
const equipmentId = (index: number) => `equipment:equipment-${index}`;
const equipmentInstanceId = (index: number) =>
  `equipment_instance:instance-${index}`;

const staff = [
  [
    "staff-1",
    "Прокопів Роман Васильович",
  ...
  [
    "staff-10",
    "Щупляк Нестор Михайлович",
    "Викладач електроніки та мікроелектроніки",
  ],
  [
    "staff-11",
    "Волянський Іван Ігорович",
    "Викладач комп’ютерно-інтегрованого управління",
  ],
  [
    "staff-12",
    "Щуцька Марія Іванівна",
    "Викладачка метрології та технологічних процесів",
  ],
] as const;
...
const rooms = [
  {
    ...
    roomTypeId: "room_type:lab",
    responsibleId: "user:staff-1",
    number: "101",
    name: "Лабораторія програмування",
    floor: 1,
    capacity: 24,
    description:
      "Навчальна лабораторія для занять зі спеціальності F2 Інженерія програмного забезпечення.",
  },
  {
    id: "room-2",
    buildingId: "building:main",
    roomTypeId: "room_type:lab",
    responsibleId: "user:staff-2",
    number: "102",
    name: "Лабораторія комп’ютерної графіки",
    floor: 1,
    capacity: 22,
    description:
      "Робочі місця для дизайну, комп’ютерної графіки та проєктування.",
  },
  {
    id: "room-3",
    buildingId: "building:main",
    roomTypeId: "room_type:classroom",
    responsibleId: "user:staff-8",
    number: "115",
    name: "Навчальна аудиторія",
    floor: 1,
    capacity: 30,
    description: "Звичайна навчальна аудиторія для теоретичних занять.",
  },
  {
    id: "room-4",
    buildingId: "building:lab",
    roomTypeId: "room_type:lab",
    responsibleId: "user:staff-3",
    number: "203",
    name: "Лабораторія автоматизації та робототехніки",
    floor: 2,
    capacity: 18,
    description:
      "Обладнання для автоматизації, робототехніки та мікроконтролерів.",
  },
  {
    id: "room-5",
    buildingId: "building:lab",
    roomTypeId: "room_type:server",
    responsibleId: "user:staff-5",
    number: "207",
    name: "Серверна та мережевий вузол",
    floor: 2,
    capacity: 6,
    description: "Комунікаційне обладнання, сервери та резервне живлення.",
  },
  {
    id: "room-6",
    buildingId: "building:workshop",
    roomTypeId: "room_type:workshop",
    responsibleId: "user:staff-4",
    number: "301",
    name: "Майстерня верстатів та інструментів",
    floor: 1,
    capacity: 16,
    description: "Виробнича зона для машинобудівних дисциплін.",
  },
  {
    id: "room-7",
    buildingId: "building:workshop",
    roomTypeId: "room_type:workshop",
    responsibleId: "user:staff-7",
    number: "304",
    name: "Слюсарно-механічна майстерня",
    floor: 1,
    capacity: 18,
    description:
      "Інструменти, стенди та витратне обладнання для практичних занять.",
  },
  {
    id: "room-8",
    buildingId: "building:main",
    roomTypeId: "room_type:library",
    responsibleId: "user:staff-6",
    number: "120",
    name: "Бібліотека та електронний читальний зал",
    floor: 1,
    capacity: 20,
    description:
      "Фондова зона, читальні місця та техніка для електронної бібліотеки.",
  },
  {
    id: "room-9",
    buildingId: "building:auxiliary",
    roomTypeId: "room_type:storage",
    responsibleId: "user:staff-5",
    number: "С-01",
    name: "Склад інвентарного фонду",
    floor: 0,
    capacity: 12,
    description:
      "Тимчасове зберігання обладнання перед передачею у приміщення.",
  },
  {
    id: "room-10",
    buildingId: "building:annex",
    roomTypeId: "room_type:classroom",
    responsibleId: "user:staff-8",
    number: "401",
    name: "Аудиторія обліку і діловодства",
    floor: 4,
    capacity: 28,
    description: "Навчальна аудиторія для облікових та архівних дисциплін.",
  },
  {
    id: "room-11",
    buildingId: "building:annex",
    ...
    responsibleId: "user:staff-2",
    number: "402",
    name: "Лабораторія офісних систем",
    floor: 4,
    capacity: 20,
    description: "ПК та периферія для роботи з офісними й архівними системами.",
  },
  {
    id: "room-12",
    buildingId: "building:lab",
    ...
    responsibleId: "user:staff-3",
    number: "214",
    name: "Лабораторія вимірювальної техніки",
    floor: 2,
    capacity: 16,
    description: "Вимірювальні стенди, мультиметри й навчальні комплекти.",
  },
  {
    id: "room-13",
    buildingId: "building:main",
    ...
    responsibleId: "user:staff-1",
    number: "210",
    name: "Лекційна аудиторія",
    floor: 2,
    capacity: 34,
    description: "Аудиторія для потокових занять і презентацій.",
  },
  {
    id: "room-14",
    buildingId: "building:auxiliary",
    ...
    responsibleId: "user:staff-7",
    number: "С-02",
    name: "Склад майстерень",
    floor: 0,
    capacity: 10,
    description:
      "Запасні інструменти, кабелі, матеріали та витратні комплекти.",
  },
  {
    id: "room-15",
    buildingId: "building:workshop",
    ...
    responsibleId: "user:staff-4",
    number: "307",
    name: "Навчальна зона ЧПК",
    floor: 1,
    capacity: 12,
    description: "Верстати, макети й обладнання для занять з ЧПК.",
  },
  {
    id: "room-16",
    buildingId: "building:main",
    roomTypeId: "room_type:office",
    responsibleId: "user:admin",
    number: "К-01",
    name: "Кабінет адміністратора обліку",
    floor: 1,
    capacity: 4,
    description: "Робоче місце адміністратора системи обліку.",
  },
] as const;
...
const equipmentNames = [
  ...
  [
    "Моноблок Lenovo ThinkCentre Neo",
    "Lenovo",
    "ThinkCentre Neo",
    "category:computer",
  ],
  ...
  [
    "Інтерактивна панель Promethean ActivPanel",
    "Promethean",
    "ActivPanel",
    "category:multimedia",
  ],
  ...
  [
    "Навчальний робот DOBOT Magician Lite",
    "Dobot",
    "Magician Lite",
    "category:robotics",
  ],
  [
    "Комплект Arduino Education",
    "Arduino",
    "Education Kit",
    "category:robotics",
  ],
  ...
  [
    "Набір слюсарного інструменту Intertool",
    "Intertool",
    "ET-6001",
    "category:tools",
  ],
  [
    "Штангенциркуль цифровий Mitutoyo",
    "Mitutoyo",
    "Absolute",
    "category:tools",
  ],
  [
    "Комплект навчальних стендів пневматики",
    "Festo",
    "Didactic",
    "category:lab",
  ],
  ...
  [
    "Комплект меблів для лабораторії",
    "Nowy Styl",
    "LabDesk",
    "category:furniture",
  ],
  [
    "Стілець лабораторний регульований",
    "Nowy Styl",
    "Lab Chair",
    "category:furniture",
  ],
  ...
  [
    "Екран моторизований 120 дюймів",
    "Reflecta",
    "CrystalLine",
    "category:multimedia",
  ],
  ...
  [
    "Комплект кабелів HDMI/DisplayPort",
    "Cablexpert",
    "EduPack",
    "category:peripheral",
  ],
  [
    "Лабораторний візок для обладнання",
    "Україна",
    "ВЛ-2",
    "category:furniture",
  ],
...
export async function seedDatabase(db: Surreal) {
  ...
  if (bootstrap && Number(bootstrap.version ?? 0) >= SEED_VERSION)
    return { seeded: false };
  ...
  await upsertRecord(db, "user", "admin", {
    fullName: "Стахів Андрій Ігорович",
    email: userEmails.admin,
    passwordHash: adminHash,
    role: "admin",
    status: "active",
    position:
      "Адміністратор системи EquipTrack; відповідальний за інвентарний облік",
    createdAt,
  });
  await upsertRecord(db, "user", "manager-1", {
    fullName: "Яцинич Оксана Борисівна",
    email: userEmails["manager-1"],
    passwordHash: managerHash,
    role: "inventory_manager",
    status: "active",
    position: "Заступниця директора з навчальної роботи",
    createdAt,
  });
  await upsertRecord(db, "user", "manager-2", {
    fullName: "Лазарів Михайло Миколайович",
    email: userEmails["manager-2"],
    passwordHash: managerHash,
    role: "inventory_manager",
    status: "active",
    position:
      "Завідувач відділення автоматизації та комп’ютерно-інтегрованих технологій",
    createdAt,
  });
  for (const [id, fullName, position] of staff)
    await upsertRecord(db, "user", id, {
      fullName,
      email: userEmails[id],
  ...
  await upsertRecord(db, "building", "main", {
    name: "Головний корпус ДМТФК",
    code: "ГК",
    address: "м. Дрогобич, вул. Раневицька, 12",
    isActive: true,
    createdAt,
  });
  await upsertRecord(db, "building", "lab", {
    name: "Навчально-лабораторний корпус",
    code: "ЛК",
    address: "кампус ДМТФК, лабораторна зона",
    isActive: true,
    createdAt,
  });
  await upsertRecord(db, "building", "workshop", {
    name: "Виробничо-механічний корпус",
    code: "ВК",
    address: "кампус ДМТФК, майстерні",
    isActive: true,
    createdAt,
  });
  await upsertRecord(db, "building", "annex", {
    name: "Навчальний корпус №3",
    code: "К3",
    address: "кампус ДМТФК, навчальний блок",
    isActive: true,
    createdAt,
  });
  await upsertRecord(db, "building", "auxiliary", {
    name: "Складський корпус",
    code: "СК",
    address: "кампус ДМТФК, господарська зона",
    isActive: true,
    createdAt,
  });
  ...
  for (const [id, name] of roomTypes)
    await upsertRecord(db, "room_type", id, { name, slug: id, createdAt });
  ...
  for (const [id, name] of categories)
    await upsertRecord(db, "category", id, { name, slug: id, createdAt });
  for (let index = 1; index <= 8; index += 1)
    await deleteRecord(db, "category", `category-${index}`);
  for (let index = 1; index <= 5; index += 1)
    await deleteRecord(db, "room_type", `type-${index}`);
  await db.query(
    "DELETE file WHERE entityType = 'category'; UPDATE category SET imageFileId = NONE;",
  );

  const suppliers = [
    "ТОВ Навчальні технології",
    "Дрогобицький центр сервісу",
    "ТОВ Комп’ютерний світ",
    "ФОП Гнатюк Орест",
    "Львівський постачальник освіти",
    "Благодійний фонд випускників ДМТФК",
  ];
  for (const [index, name] of suppliers.entries())
    await upsertRecord(db, "supplier", `supplier-${index + 1}`, {
      name,
      type: index % 2 ? "донор" : "постачальник",
      createdAt,
    });
  ...
  for (const room of rooms)
    await upsertRecord(db, "room", room.id, {
      ...room,
      status: "active",
      createdAt,
    });
  for (let index = 1; index <= 5; index += 1) {
    ...
    await upsertRecord(db, "file", `room-image-${index}`, {
      ...image,
      name: `${room.number}-${room.name}.webp`,
      kind: "photo",
      entityType: "room",
      entityId: `room:${room.id}`,
      uploadedBy: "user:admin",
      createdAt,
    });
    await db
      .update(new RecordId("room", room.id))
      .merge({ photoFileId: fileId });
  }

  await db.query(
    "DELETE equipment_instance; DELETE movement; DELETE transfer_request; DELETE repair; DELETE audit; DELETE audit_item; DELETE writeoff_request; DELETE notification; DELETE audit_log; DELETE file WHERE entityType = 'equipment'; DELETE equipment;",
  );

  const modelQuantity = (index: number, categoryId: string) => {
    if (index === 1) return 18;
    if (index === 4) return 24;
    if (["category:peripheral", "category:tools"].includes(categoryId))
      return 14;
    if (
      ["category:computer", "category:lab", "category:robotics"].includes(
        categoryId,
      )
    )
      return 7;
    if (["category:display", "category:furniture"].includes(categoryId))
      return 8;
  ...
  for (let index = 1; index <= equipmentNames.length; index += 1) {
    ...
    for (let copy = 1; copy <= quantity; copy += 1) {
        ...
        instanceIndex % 19 === 0
          ...
          : instanceIndex % 11 === 0
            ...
            : instanceIndex % 7 === 0
              ...
              : "good";
      const status =
        condition === "damaged" || condition === "needs_repair"
          ? "in_repair"
          : instanceIndex % 17 === 0
            ? "in_storage"
            : "active";
      ...
      const instance = {
        index: instanceIndex,
        id: equipmentInstanceId(instanceIndex),
        modelId: equipmentId(index),
        roomId: targetRoom,
        responsibleId,
        condition,
        status,
      ...
      await upsertRecord(db, "movement", `initial-${instanceIndex}`, {
        equipmentId: instance.id,
        movementType: "received",
        toRoomId: targetRoom,
        toResponsibleId: responsibleId,
        performedBy: "user:admin",
        acceptedBy: responsibleId,
        movementDate: createdAt,
        reason: "Поставлено на баланс ДМТФК для навчального процесу",
        createdAt,
      });
      instanceIndex += 1;
    }
  ...
  for (let index = 1; index <= 18; index += 1) {
    ...
    await upsertRecord(db, "file", `equipment-image-${index}`, {
      ...image,
      name: `${name}.webp`,
      kind: "photo",
      entityType: "equipment",
      entityId: equipmentId(index),
      uploadedBy: "user:admin",
      createdAt,
    });
    await db
      .update(new RecordId("equipment", `equipment-${index}`))
      .merge({ photoFileId: fileId });
  }

  const pickInstance = (index: number) =>
    instances[(index - 1) % instances.length];
  const transferReasons = [
    "Підготовка лабораторії до занять",
    "Тимчасове використання на практичній роботі",
    "Повернення після обслуговування",
    "Оснащення аудиторії для демонстрації",
  ];
  for (let index = 1; index <= 54; index += 1) {
    const instance = pickInstance(index * 2);
    const eventTime = new Date(
      Date.now() - index * 55 * 60 * 1000,
    ).toISOString();
    ...
    await upsertRecord(db, "transfer_request", `request-${index}`, {
      ...
      ...(status === "approved" || status === "completed"
        ? {
            ...
            approvedAt: new Date(
              new Date(requestTime).getTime() + 25 * 60 * 1000,
            ).toISOString(),
          }
        : {}),
      ...(status === "rejected"
      ...
      ...(status === "completed"
        ? {
            completedBy: "user:manager-1",
            completedAt: new Date(
              new Date(requestTime).getTime() + 55 * 60 * 1000,
            ).toISOString(),
          }
        : {}),
    });
  ...
  for (let index = 1; index <= 42; index += 1) {
    ...
    await upsertRecord(db, "repair", `repair-${index}`, {
      ...
      issueDescription:
        index % 2
          ? "Періодично зникає живлення під час заняття."
          : "Потрібна діагностика після інтенсивного використання.",
  ...
  for (let index = 1; index <= 30; index += 1) {
    ...
    const auditTime = new Date(
      Date.now() - index * 95 * 60 * 1000,
    ).toISOString();
    const roomInstances = instances.filter(
      (entry) => entry.roomId === roomRecordId,
    );
    const actualItemCount = roomInstances.length;
    const expectedItemCount = Math.max(
      0,
      actualItemCount + (index % 5 === 0 ? 1 : index % 7 === 0 ? -1 : 0),
    );
    await upsertRecord(db, "audit", `audit-${index}`, {
      title: `Інвентаризація: ${room.number} · ${room.name}`,
      roomId: roomRecordId,
      plannedDate: new Date(Date.now() + index * 24 * 60 * 60 * 1000)
        .toISOString()
        .slice(0, 10),
      status,
      auditScope:
        "Звірення фактичної наявності за серійними та інвентарними номерами, місцем розташування і технічним станом.",
      expectedItemCount,
      ...
      itemCountDelta:
        actualItemCount === expectedItemCount
          ...
          : actualItemCount > expectedItemCount
            ? `Фактично на ${actualItemCount - expectedItemCount} позицій більше.`
            : `Фактично на ${expectedItemCount - actualItemCount} позицій менше.`,
      auditResult:
        status === "completed"
          ? "Фактичний перелік звірено із серійними номерами; розбіжності внесені до журналу."
          : "Перевірка очікує фактичного обходу приміщення.",
      auditNote:
        "Під час обходу перевірити комплектність, кабелі, маркування та відповідальну особу.",
  ...
  for (const instance of instances) {
    ...
    const isCheckedInProgress =
      auditStatus === "in_progress" && instance.index % 2 === 0;
    const resultStatus =
    ...
    await upsertRecord(db, "audit_item", `audit-item-${instance.index}`, {
      ...
      ...(resultStatus !== "pending"
        ? {
            actualRoomId: isMisplaced
              ? roomId(instance.index + 3)
              : instance.roomId,
            actualCondition: isDamaged ? "damaged" : instance.condition,
            checkedBy: "user:manager-1",
            checkedAt: createdAt,
          }
        : {}),
      createdAt,
  ...
  for (let index = 1; index <= 36; index += 1) {
    ...
    const writeoffTime = new Date(
      Date.now() - index * 110 * 60 * 1000,
    ).toISOString();
    await upsertRecord(db, "writeoff_request", `writeoff-${index}`, {
      equipmentId: instance.id,
      reason:
        index % 2
          ? "Фізичний знос після тривалого використання в майстерні."
          : "Нерентабельний ремонт та відсутність запчастин.",
      status,
      ...
      ...(status === "approved" || status === "completed"
        ? {
            ...
            completedAt: new Date(
              new Date(writeoffTime).getTime() + 40 * 60 * 1000,
            ).toISOString(),
          }
        : {}),
      ...(status === "rejected"
    ...
    await upsertRecord(db, "notification", `notification-${index}`, {
      ...
      title:
        type === "transfer_request"
          ? "Оновлено заявку на передачу"
          : type === "system"
            ? "Службове нагадування"
            : "Оновлено перелік обладнання",
      body:
        type === "transfer_request"
          ? "Перевірте стан заявки та фактичне переміщення обладнання."
          : type === "system"
            ? "Потрібно актуалізувати відповідального за приміщення."
            : `Перевірте актуальний склад обладнання у приміщенні ${rooms[(index - 1) % rooms.length].number}.`,
      isRead,
      createdAt: notificationTime,
      ...(isRead
        ? {
            readAt: new Date(
              new Date(notificationTime).getTime() + 12 * 60 * 1000,
            ).toISOString(),
          }
        : {}),
    });
  ...
  for (let index = 1; index <= 80; index += 1) {
    ...
    await upsertRecord(db, "audit_log", `log-${index}`, {
      actorId: index % 2 ? "user:manager-1" : "user:admin",
      action: index % 2 ? "equipment_instance.updated" : "audit.completed",
      entityType: index % 2 ? "equipment_instance" : "audit",
      entityId:
        index % 2 ? instance.id : `audit:audit-${((index - 1) % 30) + 1}`,
      createdAt: new Date(Date.now() - index * 22 * 60 * 1000).toISOString(),
    });
  }
  ...
  if (bootstrap)
    await db
      .update(bootstrapId)
      .merge({ version: SEED_VERSION, completedAt: now() });
  else
    await db
      .create(bootstrapId)
      .content({ version: SEED_VERSION, completedAt: now() });
  return { seeded: true };
}
