    ...
    <section className="module-page">
      <header className="module-heading">
        <div>
          ...
          <h1>Переміщення</h1>
          <p>
            Надходження, передачі між приміщеннями, ремонти та списання
            обладнання.
          </p>
        </div>
        <Dialog label="Новий рух" title="Нове переміщення обладнання">
          <MovementFormLoader />
        </Dialog>
      </header>
      <form className="filter-line">
        <input
          ...
          placeholder="Обладнання, приміщення, виконавець або причина"
        />
        <select
          name="type"
          defaultValue={search.type ?? ""}
          aria-label="Фільтр за типом руху"
        >
      ...
      <Pagination
        ...
        query={{ q: search.q, type: search.type }}
      />
    </section>
  );
}
